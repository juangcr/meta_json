...
EXAMPLE_3 = {
    "layer1_a": "text",
    "layer1_b": 3.14,
    "layer1_c": {"layer2_a": 42, "layer2_b": "more text"},
    "layer1_d": ["bit", "more", "text"],
    "layer1_e": {
        "layer2_c": [{"layer3_a": "deep"}, {"layer3_b": "deeper"}],
        "layer2_d": {"layer3_c": {"layer4_a": "deepest"}},
    },
}
...
def test_flat_list():
    output_data = ["item_1", "item_2", "item_3", "item_4", "item_5", "item_6"]
