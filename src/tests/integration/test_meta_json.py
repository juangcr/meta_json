...
def test_integration():
    ...
    if not json_path:
        ...
        with open(f"{json_path}/sample.json", "r", encoding="utf-8") as j:
            raw = j.read()
        ...
        with open(f"{json_path}/sample_types.json", "w", encoding="utf-8") as j:
            t1 = default_timer()
        ...
        with open(f"{json_path}/sample_attrs.json", "w", encoding="utf-8") as j:
            t1 = default_timer()
        ...
        with open(f"{json_path}/sample_layers.json", "w", encoding="utf-8") as j:
            t1 = default_timer()
